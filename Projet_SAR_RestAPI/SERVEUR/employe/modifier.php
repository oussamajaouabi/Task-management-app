...
if($_SERVER['REQUEST_METHOD'] == 'PUT'){
    ...
    if(!empty($donnees->id_employe) && !empty($donnees->nom) && !empty($donnees->prenom) && !empty($donnees->adresse_domiciliation) && !empty($donnees->numero_compte) && !empty($donnees->grade) && !empty($donnees->superieur_hierarchique)){
